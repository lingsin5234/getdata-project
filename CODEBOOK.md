Codebook
==========
In the final tidy data set, XYavg, the "Subject" column indicates whether the "Activity" is from the "train" data set, or the "test" data set. The "Activity" indicates which of the activities the subject was performing, i.e. sitting, standing, etc.
